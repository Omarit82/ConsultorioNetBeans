 ...
 * @author omarit
 */
public class BuscarProfesional extends javax.swing.JPanel {
    private Institucion institucion;
    private Profesional seleccionado;
    /**
     * Creates new form BuscarProfesional
     */
    public BuscarProfesional(Institucion institucion) {
    ...
    private void cambio() {
        ...
        Profesional[] profesionales = institucion.buscarProfesionalPorDniApellidoNombre(texto);
        if(profesionales.length == 0){
            area.setText("Paciente no encontrado");
        }else{
            if(profesionales[0]!=null){
                String res = "";
                for(int i=0;i<profesionales.length;i++){
                    res += (profesionales[i].getApellido()+", "+profesionales[i].getNombre()+"\n");
                    area.setText(res);
                }
            }else{
                area.setText("Paciente no encontrado");
    ...
    private void initComponents() {
        ...
        titulo.setText("Busqueda Profesional");
    ...
    private void seleccionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_seleccionarActionPerformed
        if(seleccionado != null){
            MainFrame main = (MainFrame)SwingUtilities.getWindowAncestor(this);
            main.mostrarPanel(new ProfSeleccionado(institucion,seleccionado));
        }else{
